...
public class MobileContactApp {
    ...
    public static void main(String[] args) {
        try {
            ...
            UserDetailsDTO updateUserDetailsDTO = new UserDetailsDTO(1L, "Alice", "Wonderland");
            MobileContactDTO updateMobileContactDTO = new MobileContactDTO(1L, updateUserDetailsDTO, "123456789");
